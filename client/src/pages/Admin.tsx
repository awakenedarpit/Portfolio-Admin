...
export default function Admin() {
  ...
  const dashboardSections = [
    ...
    ["hackathons", "Hackathons", "Showcase stories", "LIVE"], ["journal", "Journal", "Notes & writing", "LIVE"], ["journey", "Journey", "Timeline entries", "SOURCE"],
